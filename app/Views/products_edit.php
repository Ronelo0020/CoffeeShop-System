...
<head>
    ...
    <style>
        ...
        .form-control:focus { 
            border-color: #007bff; /* Blue for Edit mode */
            box-shadow: none;
...
<div class="sidebar">
    <div class="mb-5 text-center">
        ...
        <small class="text-muted">Management Tool</small>
    </div>
    <nav>
...
<div class="main-content">
    <div class="form-card">
        <div class="text-center mb-4">
            ...
            <h3 class="fw-bold m-0 text-dark">Modify Menu Item</h3>
            <p class="text-muted small">I-update ang impormasyon sang <b><?= $product['product_name'] ?></b>.</p>
        </div>
        ...
        <form action="<?= base_url('products/update/' . $product['id']) ?>" method="POST">
            ...
            <div class="text-center">
                <a href="<?= base_url('products') ?>" class="text-decoration-none text-muted small">
                    <i class="fas fa-arrow-left me-1"></i> Discard and Go Back
                </a>
            </div>
        </form>
    </div>
